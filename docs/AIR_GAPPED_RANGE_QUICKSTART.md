...
- the file `NCT-Air-Gapped-Range-Deployment-0.15.6-20260924.zip` uploaded to
  the Range server;
...
```sh
cd /root
unzip NCT-Air-Gapped-Range-Deployment-0.15.6-20260924.zip
...
starts NCT 0.15.6, and confirms that stored file and record counts did not go
down.
...
- the health response shows version `0.15.6`;
- the build ID is `0.15.6-range-20260924`;
